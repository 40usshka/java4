...
public class NewJFrame extends javax.swing.JFrame {
    ...
    private void jButtonAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddActionPerformed
        ...
        try {
            ...
            if(IsCorrect(down, up, step)) {
                ...
                array.add(new RecIntegral(Arrays.stream(new String[]{jTextFieldDown.getText(), jTextFieldUp.getText(), jTextFieldStep.getText(), "0"}).toList()));
            }
        }
    ...
    private void jButtonCalcActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCalcActionPerformed
        ...
        array.get(selectedRow).setDataByIndex(3, String.valueOf(calc));
